...
<jsp:useBean id="listOdr_ByCompositeQuery" scope="request" type="java.util.List" />
...
<table  class="table table-bordered"   cellspacing="0">
	...
	<c:forEach var="odrVO" items="${listOdr_ByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>" varStatus="s">
      ...
      <td width="7%" align="center" valign="middle">${odrVO.odr_time}</td>
			...
			<td  width="7%">
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/odr/odr.do">
			     ...
			     <input type="hidden" name="action"	value="checkForPayed">
			     </FORM>
			</td>
