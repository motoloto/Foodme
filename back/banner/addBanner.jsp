				...
				<div class="row clearfix block">
					<div class="row clearfix">
						<div class="col-md-12 column">
							<h3 class="text-danger">新增橫幅廣告</h3>
								<a href="<%=request.getContextPath()%>/back/banner/be_bannerMgr.jsp"><h5 class="text-success">─回到橫幅廣告管理</h5></a>
							<%-- 錯誤表列 --%>
...
<%-- 					.getRest_no() : ""%>" /> --%>
									...
									<tr>
										...
										<td colspan="3"><textarea  rows="6" name="banner_cont"
												class="form-control"
											 />${bannerVO.banner_cont }</textarea></td>
									</tr>
									<tr>
									</tr>
									<tr>
										<td>廣告圖片:</td>
										<td colspan="3"><input  class="btn btn-default" type="file" name="banner_pic">
											<br></td>
									</tr>
									<tr>

										<td align="right"><input type="hidden" name="action"
											value="insert"> <input type="submit"  class="btn btn-primary btn-lg " value="送出新增"></td>
									</tr>
