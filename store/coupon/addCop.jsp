...
<c:if test="${not empty errorMsgs}">
	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
	     ...
	     <FORM NAME="addcop" ACTION="<%=request.getContextPath()%>/cop/cop.do" method="post">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<h4>
				<b>新增餐劵</b>
			...
			<div><span style="color:red">*</span>為必填欄位</div><br>
				<div class="form-group" >
				  <table width="540" border="0" cellspacing="0" >
				    <tr >
				      <td width="120" style='text-align: left;'><span style="color:red">*</span>商品名稱:</td>
				      <td width="382" style='text-align: left;'><input type = text name="cop_name" size=30  value="<%= (copVO==null)? "" : copVO.getCop_name()%>"></td>
			        </tr>
				    <tr>
				      <td style='text-align: left;'><span style="color:red">*</span>原價:</td>
				      <td style='text-align: left;'><input type = text name="cop_orlprice" size=5 value="<%= (copVO==null)? "" : copVO.getCop_orlprice()%>">NT$</td>
			        </tr>
				    <tr >
				      <td style='text-align: left;'><span style="color:red">*</span>價格:</td>
				      <td style='text-align: left;'><input type = text name="cop_price" size=5 value="<%= (copVO==null)? "" : copVO.getCop_price()%>">NT$</td>
			        </tr>
				   
				    <tr>
				      <td style='text-align: left;'><span style="color:red">*</span>使用期限:</td>
				      <td style='text-align: left;'><input type="text" size="12" id="datepicker" name = "cop_dl" value="<%= (copVO==null)? "" : copVO.getCop_dl()%>">  
                      </td>
			        </tr>
				    <tr>
				      <td style='text-align: left;'><span style="color:red">*</span>上架:</td>
				      <td style='text-align: left;'>是<input type = radio name="cop_state" value="1" <%= (state ==1)? "checked" : ""%>>
                          &nbsp;
                                                               否<input type = radio name ="cop_state" value="0" <%= (state ==0)? "checked" : ""%>>
                      </td>
			        </tr>
			      </table>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
            ...
            <div>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <textarea name="cop_content" rows=6 cols=100 wrap = off></textarea>
            </div>
	</div>
	<div class="row clearfix">
		<div class="col-md-2 column">
