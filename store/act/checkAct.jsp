...
<body>
	<div class="container">
		<div class="row clearfix">
	      ...
	      <input type = button class="btn btn-danger" value="新增活動" onclick="window.location='<%=request.getContextPath()%>/store/act/addAct.jsp'">
					
						
						
 <%if (session.getAttribute("actListOfRest")!=null){%>
<jsp:include page="listAct.jsp" />
<%} %>
