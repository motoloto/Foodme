...
<link href="<%=request.getContextPath()%>/store/css/bootstrap.min.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/store/css/style.css"
	rel="stylesheet">
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/store/js/jquery.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/store/js/bootstrap.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/store/js/scripts.js"></script>
