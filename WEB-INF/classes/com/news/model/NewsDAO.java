...
public class NewsDAO implements NewsDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT news_no,TO_CHAR(news_time,'yyyy-mm-dd')news_time,news_title,news_cont  FROM news order by news_time DESC";
	private static final String GET_ONE_STMT = "SELECT news_no, news_time,news_title,news_cont FROM news  where news_no =?  order by news_time";
