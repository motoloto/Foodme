...
public class CollectionDAO implements CollectionDAO_interface {
	...
	private static final String GET_ONE_CLC = 
			"SELECT MEM_NO,REST_NO FROM COLLECTION where MEM_NO = ? and REST_NO=?";
	...
	public CollectionVO findOneClc(Integer mem_no,Integer rest_no) {
		...
		try {
			...
			pstmt = con.prepareStatement(GET_ONE_CLC);
