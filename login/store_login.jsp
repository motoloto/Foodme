	...
	<div class=" container-fluid container"
		...
		<div class="row clearfix block">
			<div class="col-md-12 column">
				<h3>FOOD me 餐廳資訊管理系統</h3>
				<FORM class="form-horizontal"  ACTION="<%=request.getContextPath()%>/storeLogin/storeLogin.do" METHOD=POST>
	
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">帳號</label>
						<div class="col-sm-10">
							<input NAME="rest_account"  class="form-control" >
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">密碼</label>
						<div class="col-sm-10">
							<input type="password" class="form-control" id="inputPassword3" NAME="rest_psw" autocomplete="off">
						</div>
					</div>
					<div class="form-group">
